...
//	private static final String[] PUBLIC_ENDPOINT = { "/swagger-ui.html" };
...
//	private static final String[] PUBLIC_ENDPOINT_GET = {"/produtos/**"};
	private static final String[] PUBLIC_ENDPOINT_GET = {
			"/produtos/**", "/categorias/**", "/csrf", "/"
	};
	
	private static final String[] PUBLIC_ENDPOINT_POST = { "/autenticacao" };
